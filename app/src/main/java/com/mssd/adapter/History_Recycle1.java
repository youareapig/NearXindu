...
public class History_Recycle1 extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final HistoryIndexBean.DataBean.T2Bean info = list.get(position);
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            history1name = (TextView) itemView.findViewById(R.id.histoty_item1_name);
            history1img = (ImageView) itemView.findViewById(R.id.histoty_item1_img);
        }
    }
}
